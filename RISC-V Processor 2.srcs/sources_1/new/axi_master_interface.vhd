    ...
    begin
        ...
        case write_state_reg is
            ...
            when ADDR_STATE_1 => 
                ...
                axi_write_addr_ch.len <= master_to_interface.burst_len;
                axi_write_addr_ch.size <= master_to_interface.burst_size;
                axi_write_addr_ch.burst_type <= master_to_interface.burst_type;
