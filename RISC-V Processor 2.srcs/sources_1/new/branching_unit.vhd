...
begin
    ...
    base_addr_sel_i <= "0" & prog_flow_cntrl(1);
    
    branch_taken <= (not prog_flow_cntrl(2) and not prog_flow_cntrl(1) and prog_flow_cntrl(0)) or 
                    (not prog_flow_cntrl(2) and prog_flow_cntrl(1) and not prog_flow_cntrl(0));
