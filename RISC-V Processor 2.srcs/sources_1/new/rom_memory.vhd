...
--    signal mem : mem_type := (
--        0 => "00000000101000010000000100010011",         -- ADDI x2, x2, 10
--        4 => "00000000000100001000000010010011",         -- ADDI x1, x1, 1
        
--        20 => "11111110001000001100100011100011",        -- BLT x1, x2, -16
--        24 => "00000000101000011000000110010011",        -- ADDI x3, x3, 10
...
--    );
    ...
    signal mem : mem_type := (
        ...
        20 => "11111110001000001100101011100011",        -- BLT x1, x2, -16
        24 => "00000000000100011000000110010011",        -- ADDI x3, x3, 1
        40 => "00000000001100100010000000100011",        -- SW x3, x4(0)
        44 => "00000000000000001111000010010011",        -- ANDI x1, x1, 0
        48 => "11111101100111111111000001101111",        -- JAL x0, -40
