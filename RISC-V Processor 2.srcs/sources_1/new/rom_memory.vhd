...
--    signal mem : mem_type := (
--        0 => "00000100000100000000000010010011",        -- ADDI x1, x0, 65
--        4 => "00000000000100000010001100100011",        -- SW x1, x0(6)
--        8 => "00000000000000000010001110100011",        -- SW x0, x0(7)
        
--        12 => "00001110010000000000000010010011",       -- ADDI x1, x0, 0xE4
--        16 => "00000000000100000010000010100011",       -- SW x1, x0(1)
        
--        20 => "00000000001000000000000010010011",       -- ADDI x1, x0, 2
--        24 => "00000000000100000010001000100011",       -- SW x1, x0(4)
--        28 => "00000000000000000010001000100011",       -- SW x0, x0(4)
        
--        40 => "11111111110111111111000001101111",
...
--        32 => "00000000000000000100000010110111",       -- LUI x1, 20000
--        36 => "11111111111100001000000010010011",       -- ADDI x1, x1, -1
--        40 => "11111110000100000001111011100011",       -- BNE x1, x0, -4
        
--        44 => "00000000000000000010000100000011",       -- LW x2, x0(0)
        
--        48 => "11111111110111111111000001101111",       -- JAL x0, -4
        
--        others => (others => '0')
--    );
    
        -- UART RECEIVER AND TRANSMITTER TEST
        signal mem : mem_type := (
            0 => "00000100000100000000000010010011",        -- ADDI x1, x0, 65      $ Setting the divisor (lsb) into x1
            4 => "00000000000100000010001100100011",        -- SW x1, x0(6)         $ Put divisor into UART controller register
            8 => "00000000000000000010001110100011",        -- SW x0, x0(7)         $ Zero out msb part of divisor
            
            20 => "00000000000100000000000010010011",       -- ADDI x1, x0, 1       $ Make receiver listen to incoming data
            24 => "00000000000100000010001000100011",       -- SW x1, x0(4)
            28 => "00000000000000000010001000100011",       -- SW x0, x0(4)
            
            32 => "00000010000000000000000010110111",       -- LUI x1, 4194304      $ Wait for some time
            36 => "11111111111100001000000010010011",       -- ADDI x1, x1, -1
            40 => "11111110000100000001111011100011",       -- BNE x1, x0, -4
            
            44 => "00000000000000000010000100000011",       -- LW x2, x0(0)
        
            48 => "00000000001000000000000010010011",       -- ADDI x1, x0, 2       $ Start TX command in x1
            52 => "00000011101100000000000110010011",       -- ADDI x3, x0, 59 (Y)  $ Send character Y
            56 => "00000000001100000010000010100011",       -- SW x3, x0(1)         $ Store character into tx hold register
            60 => "00000000000100000010001000100011",       -- SW x1, x0(4)         $ Send command to start transmission
            64 => "00000000000000000010001000100011",       -- SW x0, x0(4)         $ Reset command to start transmission (So that it doesnt keep sending chars indefinitely)
        
            80 => "11111111110111111111000001101111",       -- JAL x0, -4
            others => (others => '0')
    );
