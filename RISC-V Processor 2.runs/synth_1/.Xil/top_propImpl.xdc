set_property SRC_FILE_INFO {cfile:{c:/Vivado Projects/RISC-V Processor/RISC-V-Processor-2/RISC-V Processor 2.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.xdc} rfile:{../../../RISC-V Processor 2.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.xdc} id:1 order:EARLY scoped_inst:your_instance_name/inst} [current_design]
set_property SRC_FILE_INFO {cfile:{C:/Vivado Projects/RISC-V Processor/RISC-V-Processor-2/RISC-V Processor 2.srcs/constrs_1/new/nexys_a7_constr.xdc} rfile:{../../../RISC-V Processor 2.srcs/constrs_1/new/nexys_a7_constr.xdc} id:2} [current_design]
